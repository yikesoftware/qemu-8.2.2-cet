...
// ##################### CET #####################
// try export uint64_t cet_status in qemu
// extern uint64_t cet_status;
// ###############################################
...
#define TARGET_ARCH_CET_STATUS ARCH_CET_STATUS
#define TARGET_ARCH_CET_DISABLE ARCH_CET_DISABLE
#define TARGET_ARCH_CET_LOCK ARCH_CET_LOCK
// #########################################################
    abi_long ret = 0;
    abi_ulong val;
    int idx;
    //printf("arch_prctl code: 0x%x\n", code);
    switch(code) {
    ...
    case TARGET_ARCH_GET_FS:
        ...
        if (put_user(val, addr, abi_ulong))
            ret = -TARGET_EFAULT;
        break;
    case TARGET_ARCH_CET_STATUS:{
        abi_ulong buf[3] = {0};
        buf[0] |= GNU_PROPERTY_X86_FEATURE_1_IBT | GNU_PROPERTY_X86_FEATURE_1_SHSTK;
        // copy to user
        put_user(buf[0], addr, abi_ulong);
        put_user(buf[1], addr+sizeof(abi_ulong), abi_ulong);
        put_user(buf[2], addr+sizeof(abi_ulong)*2, abi_ulong);
        ret = 0;
        break;
        }
    case TARGET_ARCH_CET_DISABLE:{
        ret = 0;
        break;
    }
    case TARGET_ARCH_CET_LOCK:{
        ret = 0;
        break;
    }
    default:
    ...
    //printf("arch_prctl return: 0x%lx\n", ret);
    return ret;
}
                            ...
                            abi_long arg8)
{
    ...
    //printf("do_syscall1: num=%d, arg1=0x%lx, arg2=0x%lx, arg3=0x%lx, arg4=0x%lx, arg5=0x%lx, arg6=0x%lx, arg7=0x%lx, arg8=0x%lx\n", num, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    switch(num) {
    case TARGET_NR_exit:
